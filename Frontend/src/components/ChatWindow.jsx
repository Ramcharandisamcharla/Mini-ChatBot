  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-gray-900 overflow-hidden md:min-h-0">
      ...
      <div 
        ...
        className="absolute md:relative top-14 md:top-0 left-0 right-0 bottom-0 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 pb-32 md:pb-0 md:flex-1 md:min-h-0"
      >
